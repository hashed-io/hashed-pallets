...
pub mod pallet {
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		/// The reserve balance of the asset with asset_id is increased by amount. A named reserve
		/// with id is added to reserves.
		///
		...
		/// The reserve balance of the asset with asset_id is decreased by amount. The named reserve
		/// with id is removed.
		///
